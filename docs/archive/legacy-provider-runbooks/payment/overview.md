...
> 🪙 **积分系统**：如需配置 AI 积分消耗功能，请参阅[积分系统 Runbook](../credits.md)。
...
8. **[支付测试 Runbook](./testing.md)** - 历史本地开发测试和 Webhook 调试
...
### 相关指南
- [支付测试 Runbook](./testing.md) - 历史本地开发测试和 Webhook 调试
