...
5. 以 TEST-CATALOG #40 推进 Kernel Bar + 全尺寸 App Surface、Default Chat App、剩余完整 Chat Core contract、ready Revision 实时更新和 publish barrier；结构化 member/Agent Mention 与跨 initial-sync 历史分页已有定向双 Chromium 证据。
