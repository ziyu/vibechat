...
5. 以 TEST-CATALOG #40 推进 Kernel Bar + 全尺寸 App Surface、ready Revision 实时更新、publish barrier、App 代理故障与信任边界；Default/Custom 共用 Chat Core contract、结构化 member/Agent Mention 与跨 initial-sync 历史分页已有定向双 Chromium 证据。
