...
> 💡 **AI 快速配置：** 已安装 [Agent Skills](https://github.com/TinyshipCN/tinyship-skills) 的用户可以直接对 AI 说「帮我配置品牌信息」，使用 `tinyship-brand` skill 交互式完成配置。
...
2. **放置文件**：
   ...
   - 同时也需要放入 `apps/nuxt-app/public/`、`apps/web-app/public/` 和 `apps/docs-app/public/` 目录
