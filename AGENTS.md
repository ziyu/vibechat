...
This project is indexed by GitNexus as **vibechat** (8488 symbols, 18096 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
