...
This project is indexed by GitNexus as **vibechat** (9475 symbols, 20365 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
