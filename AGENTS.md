...
This project is indexed by GitNexus as **vibechat** (8782 symbols, 18737 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
