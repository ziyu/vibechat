...
This project is indexed by GitNexus as **vibechat** (8958 symbols, 18845 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
