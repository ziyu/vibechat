...
This project is indexed by GitNexus as **vibechat** (7126 symbols, 15085 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
