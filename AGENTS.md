...
This project is indexed by GitNexus as **vibechat** (7146 symbols, 15278 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
