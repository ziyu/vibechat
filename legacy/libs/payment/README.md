...
- **TanStack Start**: 参考 `apps/web-app/src/routes/api/payment/initiate.ts`
...
- **TanStack Start**: 参考 `apps/web-app/src/routes/api/payment/webhook/$provider.ts`
...
- [归档支付 Runbook](../../../docs/archive/legacy-provider-runbooks/payment/overview.md) - 历史支付配置与操作步骤
