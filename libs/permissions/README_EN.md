# Vibe Chat Permission Control System

This is a permission control system based on CASL for controlling user access to different resources in Vibe Chat applications. Supports Next.js, Nuxt.js, and TanStack Start applications.
