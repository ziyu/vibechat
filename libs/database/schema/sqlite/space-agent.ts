...
export const spaceAgentDefinition = sqliteTable('space_agent_definition', {
  ...
  capabilitiesJson: text('capabilities_json', { mode: 'json' }).$type<string[]>().notNull().default([]),
...
export const spaceAgentBinding = sqliteTable('space_agent_binding', {
  ...
  toolPolicyId: text('tool_policy_id').notNull(),
  budgetPolicyJson: text('budget_policy_json', { mode: 'json' }).$type<{
...
export const spaceAgentSession = sqliteTable('space_agent_session', {
...
export const spaceAgentAuditEvent = sqliteTable('space_agent_audit_event', {
  ...
  resultJson: text('result_json', { mode: 'json' }).$type<Record<string, unknown>>().notNull().default({}),
  createdAt: integer('created_at', { mode: 'timestamp' }).notNull().$defaultFn(() => new Date()),
}, (table) => [
