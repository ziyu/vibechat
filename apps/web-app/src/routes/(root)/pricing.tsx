...
export const Route = createFileRoute('/(root)/pricing')({
  head: ({ match }) => seoHead(match.context.locale, (t) => t.pricing.metadata),
    ...
    const interval = setInterval(async () => {
      try {
        ...
        if (data.status === 'paid') {
          ...
          window.location.href = '/payment-success?provider=wechat'
