...
export const Route = createFileRoute('/(root)/premium-features')({
  beforeLoad: async ({ location }) => {
    await requireSubscription(location.href)
  },
  head: ({ match }) => seoHead(match.context.locale, (t) => t.premiumFeatures.metadata),
