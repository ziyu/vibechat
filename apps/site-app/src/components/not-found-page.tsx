  ...
  return (
    <main className="grid min-h-svh place-items-center bg-background px-6 py-16">
      ...
      <section className="w-full max-w-2xl text-center">
        <Link to="/" aria-label={config.app.name} className="mb-12 inline-flex rounded-xl"><Logo size="md" /></Link>
        ...
        <Link to="/" className="mt-10 inline-flex items-center gap-2 rounded-xl bg-foreground px-6 py-3 text-sm font-semibold text-background">
