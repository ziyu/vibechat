...
4. Create a new theme file in `packages/ui/src/styles/themes/`
...
1. Create a new theme file in `packages/ui/src/styles/themes/`
...
```css
/* packages/ui/src/styles/themes/mytheme.css */
.theme-mytheme {
...
1. Add your theme import to `packages/ui/src/styles/index.css`:
   ```css
   @import './themes/mytheme.css';
   ```

2. Update `packages/ui/src/themes.ts` configuration:
   ```typescript
