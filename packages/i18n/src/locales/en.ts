...
export const en: Locale = {
  ...
  chatApp: {
    ...
    spaces: {
      ...
      heroTitle: "Every conversation now has a place to become something.",
      heroDescription: "A Space is the whole thing: people, full Chat, a programmable App, and the Agent that helps shape it.",
      ...
      createCardTitle: "Create another Space",
      createCardDescription: "Choose people, copy a template, and enter a complete Chat immediately.",
