...
export const en: Locale = {
  ...
  chatApp: {
    ...
    newSpace: {
      ...
      spaceTitle: "Choose a Space Template",
      spaceDescription: "Each template is copied into this Space as an independent App Project. Full Chat is always available.",
