...
export const en: Locale = {
  ...
  admin: {
    ...
    agents: {
      ...
      description: "Version immutable definitions, bind approved Agents to Spaces, and review bounded policy audit records.",
      refresh: "Refresh",
      loading: "Loading Agent governance state...",
      loadFailed: "Agent governance state could not be loaded.",
      saved: "Governance state saved.",
      retry: "Retry",
      metrics: {
      ...
      filters: {
        title: "Scope",
        description: "Filter bindings and audit by Space. Leave blank for the bounded platform view.",
        spaceInstanceId: "Space instance ID",
        agentId: "Agent ID",
        apply: "Apply scope",
        clear: "Clear"
      },
      definitions: {
        ...
        description: "Definitions are immutable. Create a newer semantic version to change provider-neutral policy.",
        create: "Create version",
        empty: "No Agent definitions are registered.",
        version: "Version",
        adapter: "Adapter",
      ...
      createDefinition: {
        title: "New immutable Definition",
        description: "Only registered Adapters and deployment-approved dedicated pools are accepted.",
        agentId: "Agent ID",
        ...
        toolPolicy: "Tool policy ID",
        pricingPolicy: "Pricing policy ID",
        maxBudget: "Maximum credits",
        maxConcurrency: "Maximum concurrency",
        availability: "Availability",
        regionMode: "Data region policy",
        regions: "Allowed regions (comma separated)",
        poolMode: "Execution pool policy",
        poolClass: "Dedicated pool class",
        submit: "Create immutable version",
        cancel: "Close editor"
      },
      bindings: {
        title: "Space bindings",
        description: "A default switch affects new Turns only; queued and active Turns retain their pinned Definition and session generation.",
        empty: "No bindings match this scope.",
        space: "Space",
        agent: "Agent",
        ...
        default: "Default",
        disabled: "Disabled",
        edit: "Configure binding",
        save: "Save binding",
        permissionPolicy: "Permission policy ID",
        toolPolicy: "Tool policy ID",
        maxCredits: "Credits per Turn",
        maxInputTokens: "Maximum input tokens",
        maxOutputTokens: "Maximum output tokens",
        status: "Binding status",
        chooseDefinition: "Choose Definition"
      },
      audit: {
        title: "Governance audit",
        description: "Latest bounded policy and governance events. Credentials, prompts, and source are never included.",
        empty: "No governance audit records match this scope.",
        event: "Event",
        subject: "Subject",
      ...
      options: {
        ...
        allowlistRegion: "Region allowlist",
        requiredRegion: "Required region",
        regionalShared: "Regional shared pool",
  ...
  chatApp: {
    ...
    matrix: {
      ...
      description: "Space membership and Chat timelines are synced from Matrix. This browser only keeps SDK cache and interface preferences."
    },
    service: {
      ...
      unavailable: "Spaces are not connected",
      unavailableDescription: "Your account is ready, but this environment has no active Synapse connection for Space membership and Chat. No demo data has been substituted.",
      failed: "Spaces could not start",
    ...
    onboarding: {
      ...
      storyTitle: "Choose the people. Then give the Space a life of its own.",
      storyDescription: "Every Space keeps full Chat inside a trusted Kernel, with an App you and Agents can continue to shape.",
      ...
      setAtmosphereDescription: "Every Space gets a deliberate shared canvas.",
    ...
    spaces: {
      ...
      noResults: "No Spaces here",
      noResultsDescription: "Try another search or turn off the unread filter.",
      matrixSynced: "Matrix timeline synced",
      activitySynced: "Space activity is up to date",
      kernelReady: "Kernel · Chat · App",
      headerSubtitle: "Where your friends are",
      heroKicker: "Your living collection",
      heroTitle: "Go where the people are.",
      heroDescription: "Light, sound, and a half-finished thought tell you what friends are doing faster than an unread count.",
      statsLabel: "Space collection summary",
      spaceCount: "Spaces",
      memberCount: "People",
      unreadCount: "Unread",
      collectionKicker: "Open a door",
      collectionTitle: "Your Spaces",
      browseTemplates: "Browse templates",
      browseTemplatesDescription: "Find a room with its own rhythm.",
      openFinder: "Find a Space",
      closeFinder: "Close Space finder",
      otherSpaces: "Other rooms",
      viewAll: "See every Space",
      roomPresence: "{count} here · {time}",
      unreadBadge: "{count} unread",
      emptyChat: "Chat is ready for the first message.",
      createCardTitle: "Leave a light on",
      createCardDescription: "Create a Space and invite people in when you are ready.",
      emptyTitle: "Your first Space is waiting",
      emptyDescription: "Choose people and a template. Chat works immediately; the App can keep evolving."
    },
    space: {
      ...
      hideControls: "Hide Space controls",
      showControls: "Show Space controls",
      matrixSpace: "Matrix-backed Space",
      memberCount: "{count} members in this Space",
      sending: "Sending…",
      sent: "Sent",
      ...
      deleteMessageConfirm: "Everyone in the Space will see that this message was deleted. Continue?",
    ...
    spaceRuntime: {
      ...
      preparingApp: "Preparing this Space App",
      preparingAppDescription: "The last ready revision will appear here as soon as the runtime is connected.",
      appUnavailable: "This Space App could not connect",
      appUnavailableDescription: "The last ready revision and Chat Core remain intact. Retry the runtime connection.",
      retryApp: "Retry",
      updating: "Updating",
      ready: "Ready",
      ...
      applyTemplate: "Apply Space Template",
      applyTemplateTitle: "Apply a Space Template?",
    ...
    newSpace: {
      ...
      peopleDescription: "Invite up to 50 contacts, or continue alone and invite people later.",
      spaceTitle: "Choose how this Space starts",
      spaceDescription: "Start blank with the Default Chat App, or copy a fixed Template version into an independent App Project.",
      reviewTitle: "One last look",
      reviewDescription: "Review the members, template version, and requested capabilities before creating the Space.",
      progressLabel: "New Space progress",
      searchPeople: "Search your contacts",
      selectedPeople: "Selected people",
      startMode: "Starting point",
      blank: "Blank Space",
      blankName: "New Space",
      blankDescription: "Start immediately with the platform Default Chat App, then apply a Template or ask an Agent to reshape it.",
      defaultChatIncluded: "Default Chat App included",
      blankPermissionSummary: "Trusted Chat Core only · no external network",
      template: "Space Template",
      templateVersion: "App Template v{version}",
      participants: "Participants",
      justYou: "Just you for now",
      permissions: "Capabilities",
      permissionSummary: "{count} declared capabilities · no external network",
      matrixNotice: "This creates one private Matrix-backed Space. Its App is immediately usable and keeps updating when a new revision becomes ready.",
      create: "Create Space",
      creating: "Creating…",
      createFailed: "The Space could not be created. Check the selected contacts and try again."
    },
    contacts: {
      kicker: "People you know",
      title: "Contacts",
      description: "Start with trust, then create a Space where Chat and an App can grow together.",
      ...
      emptyTitle: "People make a Space feel alive",
      emptyDescription: "Search by name or username to add your first contact.",
      addContact: "Send friend request",
      requestSent: "Friend request sent",
      allContacts: "All contacts",
      contactProfile: "Contact profile",
      startSpace: "Create a Space",
      addToSpace: "Add to a Space",
      sharedSpaces: "Shared Spaces",
      acceptSpaceInvite: "Accept Space invitation",
      declineSpaceInvite: "Decline Space invitation",
      ...
      blockConfirm: "Blocking removes the contact relationship and prevents new friend requests and Space invitations. Continue?"
    },
    discover: {
      kicker: "Space Template Market",
      title: "Start with a living App Project.",
      description: "Each Space Template combines full Chat with a versioned App Project you and Agents can continue to shape.",
      searchPlaceholder: "Search templates or creators",
      ...
      noResults: "No Space Template matched",
      ...
      useThisSpace: "Create Space from Template"
    },
    me: {
      kicker: "Your corner",
      title: "Me",
      ...
      notificationsDescription: "Space activity and contextual prompts",
      appearance: "Appearance",
      ...
      helpDescription: "Learn how Spaces, Chat, Apps, and Agents work together",
