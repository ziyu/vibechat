...
export const zhCN: Locale = {
  ...
  adminApp: {
    ...
    workspace: "运营工作台",
    environment: "实时运营",
    secureWorkspace: "受限工作区",
    openProduct: "打开产品",
    signInTitle: "需要管理员登录",
    signInDescription: "正在打开 Vibe Chat 登录页，登录成功后会返回此运营工作台。",
    openSignIn: "打开登录页",
    forbiddenTitle: "需要管理员权限",
    forbiddenDescription: "当前账号已经登录，但没有权限访问运营数据。",
  },
  admin: {
    metadata: {
    ...
    agents: {
      eyebrow: "Agent 控制平面",
      title: "Agent 治理",
      description: "管理不可变 Definition 版本、Space Agent 绑定，以及有界的策略审计记录。",
      refresh: "刷新",
      loading: "正在加载 Agent 治理状态...",
      loadFailed: "无法加载 Agent 治理状态。",
      saved: "治理状态已保存。",
      retry: "重试",
      metrics: {
        definitions: "Definition 数",
        active: "活跃版本",
        bindings: "Space 绑定",
        audit: "审计记录"
      },
      filters: {
        title: "治理范围",
        description: "可按 Space 筛选绑定与审计；留空时显示有界的平台视图。",
        spaceInstanceId: "Space 实例 ID",
        agentId: "Agent ID",
        apply: "应用范围",
        clear: "清除"
      },
      definitions: {
        ...
        description: "Definition 不可变；策略变化必须创建更高的语义版本。",
        create: "创建版本",
        empty: "尚未注册 Agent Definition。",
        version: "版本",
        adapter: "Adapter",
        model: "Provider / 模型",
        region: "区域",
      ...
      createDefinition: {
        title: "新建不可变 Definition",
        description: "只接受已注册 Adapter 和部署 allowlist 内的专属 pool。",
        agentId: "Agent ID",
        version: "语义版本",
        adapter: "Adapter",
        ...
        model: "模型",
        displayName: "展示名称",
        descriptionLabel: "公开说明",
        capabilities: "能力（逗号分隔）",
        toolPolicy: "工具策略 ID",
        pricingPolicy: "计费策略 ID",
        maxBudget: "最大积分",
        maxConcurrency: "最大并发",
        availability: "可用性",
        regionMode: "数据区域策略",
        regions: "允许区域（逗号分隔）",
        poolMode: "执行池策略",
        poolClass: "专属 pool class",
        submit: "创建不可变版本",
        cancel: "关闭编辑器"
      },
      bindings: {
        title: "Space 绑定",
        description: "默认项切换只影响新 Turn；已排队和执行中的 Turn 继续使用固定的 Definition 与 session generation。",
        empty: "当前范围没有绑定。",
        space: "Space",
        agent: "Agent",
        ...
        edit: "配置绑定",
        save: "保存绑定",
        permissionPolicy: "权限策略 ID",
        toolPolicy: "工具策略 ID",
        maxCredits: "每 Turn 积分",
        maxInputTokens: "最大输入 Token",
        maxOutputTokens: "最大输出 Token",
        status: "绑定状态",
        chooseDefinition: "选择 Definition"
      },
      audit: {
        title: "治理审计",
        description: "最近的有界策略与治理事件；不会包含 credential、prompt 或源码。",
        empty: "当前范围没有治理审计记录。",
        event: "事件",
        subject: "对象",
        result: "有界结果",
      ...
      options: {
        ...
        unavailable: "不可用",
        anyRegion: "任意区域",
        allowlistRegion: "区域 allowlist",
        requiredRegion: "指定区域",
        regionalShared: "区域共享池",
        dedicated: "专属池",
        active: "活跃",
        disabled: "禁用",
        yes: "是",
  ...
  chatApp: {
    ...
    matrix: {
      title: "Synapse 已连接",
      description: "Space 成员与 Chat 时间线由 Matrix 同步；当前浏览器只保存 SDK 缓存和界面偏好。"
    },
    service: {
      connecting: "正在连接你的账号",
      connectingDescription: "正在读取产品资料、偏好、联系人和当前 Matrix 设备会话。",
      unavailable: "Space 服务尚未连接",
      unavailableDescription: "账号已经就绪，但当前环境没有可用于 Space 成员和 Chat 的 Synapse 连接；系统不会用演示数据代替。",
      failed: "Space 服务启动失败",
      failedDescription: "你的账号数据没有被改动。请检查服务后重新连接。"
    },
    onboarding: {
      kicker: "从一个小小的开始",
      storyTitle: "先选人，再让这个 Space 拥有自己的生命。",
      storyDescription: "每个 Space 都在可信 Kernel 中保留完整 Chat，并拥有一个可以和 Agent 一起持续塑造的 App。",
      pickPeople: "先从人开始",
      pickPeopleDescription: "联系人和邀请始终由你掌控。",
      setAtmosphere: "再设置氛围",
      setAtmosphereDescription: "每个 Space 都有明确选择的共享画布。",
      keepControl: "保留宿主控制",
    ...
    spaces: {
      ...
      title: "空间",
      newSpace: "新建 Space",
      searchPlaceholder: "搜索你的 Space",
      unread: "未读",
      muted: "已静音",
      spaceActions: "Space 操作",
      pin: "置顶 Space",
      unpin: "取消置顶 Space",
      mute: "静音 Space",
      unmute: "取消静音 Space",
      markRead: "标记为已读",
      noResults: "这里没有 Space",
      noResultsDescription: "试试其他搜索词，或关闭未读筛选。",
      matrixSynced: "Matrix 时间线已同步",
      activitySynced: "Space 动态已同步",
      kernelReady: "Kernel · Chat · App",
      headerSubtitle: "朋友们正在的地方",
      heroKicker: "你的活空间集合",
      heroTitle: "去有人的房间。",
      heroDescription: "光线、声音和一句没说完的话，比未读数字更快告诉你：朋友们正在做什么。",
      statsLabel: "Space 集合概览",
      spaceCount: "空间",
      memberCount: "成员",
      unreadCount: "未读",
      collectionKicker: "推开一扇门",
      collectionTitle: "你的 Spaces",
      browseTemplates: "浏览模板",
      browseTemplatesDescription: "找一个有自己节奏的房间。",
      openFinder: "查找 Space",
      closeFinder: "关闭 Space 查找",
      otherSpaces: "其他房间",
      viewAll: "查看全部 Space",
      roomPresence: "{count} 人在这里 · {time}",
      unreadBadge: "{count} 条未读",
      emptyChat: "Chat 已就绪，等待第一条消息。",
      createCardTitle: "留一盏灯",
      createCardDescription: "创建一个 Space，准备好时再邀请朋友进来。",
      emptyTitle: "你的第一个 Space 正在等你",
      emptyDescription: "选择成员和模板，Chat 会立即可用，App 之后仍可持续进化。"
    },
    space: {
      notFound: "没有找到这个 Space",
      notFoundDescription: "当前账号可能已无法访问，或 Matrix 仍在同步这个 Space。",
      backToSpaces: "返回 Spaces",
      connected: "时间线已连接",
      spaceMenu: "Space 菜单",
      recoveryView: "打开基础恢复视图",
      hideControls: "收起 Space 控制",
      showControls: "显示 Space 控制",
      matrixSpace: "Matrix 实时 Space",
      memberCount: "{count} 位成员在这个 Space 里",
      sending: "发送中…",
      sent: "已发送",
      failed: "发送失败",
      retryFailed: "发送失败 · 重试",
      ...
      editMessage: "编辑消息",
      deleteMessage: "删除消息",
      deleteMessageConfirm: "删除后所有 Space 成员都会看到消息已删除。确定继续吗？",
    ...
    spaceRuntime: {
      ...
      preparingApp: "正在准备这个 Space App",
      preparingAppDescription: "Runtime 连接后会立即加载最后一个可用版本，当前 Space 不需要进入单独的试验模式。",
      appUnavailable: "暂时无法连接这个 Space App",
      appUnavailableDescription: "最后一个可用版本和 Chat Core 都保持不变，可以重新连接 Runtime。",
      retryApp: "重新连接",
      updating: "正在更新",
      ready: "可用",
      ...
      applyTemplate: "应用 Space 模板",
      applyTemplateTitle: "应用这个 Space 模板？",
    ...
    newSpace: {
      ...
      peopleDescription: "最多邀请 50 位联系人，也可以先独自创建，之后再邀请成员。",
      spaceTitle: "选择 Space 的开始方式",
      spaceDescription: "可以用默认 Chat App 空白开始，也可以把固定模板版本复制为独立 App Project。",
      reviewTitle: "最后确认一次",
      reviewDescription: "创建 Space 前，确认成员、模板版本和它申请的能力。",
      progressLabel: "新建 Space 进度",
      searchPeople: "搜索联系人",
      selectedPeople: "已选择联系人",
      startMode: "开始方式",
      blank: "空白 Space",
      blankName: "新 Space",
      blankDescription: "立即使用平台默认 Chat App，之后仍可应用模板或让 Agent 重塑整个界面。",
      defaultChatIncluded: "包含默认 Chat App",
      blankPermissionSummary: "仅使用可信 Chat Core · 不连接外部网络",
      template: "Space 模板",
      templateVersion: "App 模板 v{version}",
      participants: "参与人",
      justYou: "暂时只有你",
      permissions: "能力权限",
      permissionSummary: "声明 {count} 项能力 · 不连接外部网络",
      matrixNotice: "将创建一个由 Matrix 支撑的私有 Space；App 创建后立即可用，新版本就绪时会实时更新。",
      create: "创建 Space",
      creating: "正在创建…",
      createFailed: "Space 创建失败，请检查所选联系人后重试。"
    },
    contacts: {
      kicker: "你认识的人",
      title: "联系人",
      description: "先从信任关系开始，再创建一个让 Chat 与 App 一起生长的 Space。",
      ...
      emptyTitle: "有人在，Space 才会活起来",
      emptyDescription: "从名字或用户名开始搜索，添加你的第一位联系人。",
      addContact: "发送好友请求",
      requestSent: "好友请求已发送",
      allContacts: "全部联系人",
      ...
      startSpace: "创建 Space",
      addToSpace: "加入 Space",
      sharedSpaces: "共同的 Spaces",
      acceptSpaceInvite: "接受 Space 邀请",
      declineSpaceInvite: "拒绝 Space 邀请",
      spaceInvited: "Space 邀请",
      block: "屏蔽此用户",
      blockContact: "屏蔽联系人",
      remark: "仅自己可见的备注",
      editRemark: "修改联系人备注",
      ...
      blockConfirm: "屏蔽后将解除好友关系，并阻止新的好友请求和 Space 邀请。确定继续吗？"
    },
    discover: {
      kicker: "Space 模板市场",
      title: "从一个可运行的 App Project 开始。",
      description: "每个 Space 模板都包含完整 Chat 和可继续由成员、Agent 定制的版本化 App Project。",
      searchPlaceholder: "搜索 Space 模板或创作者",
      categoryLabel: "模板分类",
      categories: {
        all: "全部氛围",
        daily: "日常",
    ...
    me: {
      ...
      preferences: "偏好设置",
      notifications: "通知",
      notificationsDescription: "Space 动态与情境提示",
      appearance: "外观",
      ...
      help: "帮助与文档",
      helpDescription: "了解 Space、Chat、App 与 Agent 如何协作",
      accountCenter: "账户中心",
      accountCenterDescription: "订阅、积分、订单、推荐与提现"
    },
    account: {
      kicker: "账户账本",
      title: "账户中心",
      description: "所有影响访问权限和余额的记录，都以共享服务账本为准。",
      tabs: {
        overview: "概览",
        credits: "积分",
        orders: "订单",
      ...
      purchased: "累计获得",
      consumed: "累计使用",
      recentActivity: "最近账本记录",
      noTransactions: "还没有积分流水。",
      orders: "订单",
      noOrders: "还没有订单。",
      order: "订单",
      plan: "方案",
      ...
      amount: "金额",
      date: "时间",
      affiliateUnavailable: "推荐数据暂时无法读取。",
      affiliateDisabled: "推荐计划当前未开启。",
      referralLink: "你的推荐链接",
      copy: "复制",
      copied: "已复制",
      commissionBalance: "可提现佣金",
      registeredReferrals: "注册推荐",
      paidReferrals: "付费推荐",
      commissions: "佣金记录",
      referrals: "推荐用户",
      noCommissions: "还没有佣金记录。",
      noReferrals: "还没有推荐用户。",
      withdrawal: "佣金提现",
      withdrawalAmount: "提现金额",
      withdrawalMethod: "收款方式",
      withdrawalAccount: "收款账号",
      submitWithdrawal: "提交提现申请",
      submittingWithdrawal: "正在提交…",
      withdrawalSuccess: "提现申请已提交。",
      withdrawalFailed: "提现申请失败。",
      withdrawalHistory: "提现记录",
      noWithdrawals: "还没有提现申请。",
      minWithdrawal: "最低提现：{amount} {currency}",
      paymentMethods: {
        alipay: "支付宝",
        paypal: "PayPal",
        bankTransfer: "银行转账"
      ...
      security: {
        title: "账户安全",
        description: "管理密码、关联登录方式和账户删除。",
        linkedAccounts: "关联登录方式",
        linkedAt: "关联于 {date}",
        noLinkedAccounts: "暂无关联登录方式。",
        passwordTitle: "修改密码",
        currentPassword: "当前密码",
        newPassword: "新密码",
        confirmPassword: "确认新密码",
        ...
        passwordChanged: "密码已更新，其他浏览器会话已撤销。",
        passwordMismatch: "两次输入的新密码不一致。",
        passwordFailed: "密码更新失败。",
        socialOnly: "此账户仅使用第三方登录，没有本地密码。",
        dangerTitle: "删除账户",
        dangerDescription: "永久删除账户及其产品数据，此操作无法撤销。",
        activeSubscription: "删除账户前，需要先从支付服务商门户取消仍在生效的周期订阅。",
        confirmDelete: "输入 DELETE 确认",
        deletePassword: "当前密码（使用邮箱登录时）",
    ...
    services: {
      kicker: "Vibe 工具箱",
      title: "服务",
      description: "积分、存储和 AI 工具都连接到你的真实账户。",
      pricing: "订阅方案与积分包",
      pricingDescription: "价格和可用支付渠道由共享 Backend 提供。",
      loadingPlans: "正在读取方案…",
      plansFailed: "暂时无法读取方案。",
      noPlans: "当前语言下暂无有效方案。",
      buy: "使用 {provider} 继续",
      openingCheckout: "正在打开收银台…",
      checkoutFailed: "无法发起支付。",
      creditsPack: "{count} 积分",
      upload: "图片存储",
      uploadDescription: "通过已登录的存储服务上传图片。",
      chooseFile: "选择图片",
      storageProvider: "存储渠道",
      uploadNow: "上传",
      uploading: "正在上传…",
      uploadFailed: "上传失败。",
      uploaded: "上传完成",
