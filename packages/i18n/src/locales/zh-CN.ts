...
export const zhCN: Locale = {
  ...
  chatApp: {
    ...
    spaces: {
      ...
      heroKicker: "你的活空间集合",
      heroTitle: "每一段对话，都有一个可以继续生长的地方。",
      heroDescription: "Space 是完整的产品对象：这里有人、完整 Chat、可编程 App，以及帮助大家塑造它的 Agent。",
      ...
      createCardTitle: "再创建一个 Space",
      createCardDescription: "选择成员和模板，创建后立即进入完整 Chat。",
