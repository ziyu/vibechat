  ...
  <section class="vcc-shell" aria-label="Space Chat">
    <header class="vcc-head">
      ...
      <span class="vcc-head-actions">
        <button class="vcc-icon" id="vcc-attach" type="button" aria-label="Attach file"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="m21.4 11.6-8.9 8.9a6 6 0 0 1-8.5-8.5l9.6-9.6a4 4 0 0 1 5.7 5.7L9.7 17.7a2 2 0 1 1-2.8-2.8l8.9-8.9"/></svg></button>
    ...
    <div class="vcc-compose-wrap">
      ...
      <form class="vcc-compose" id="vcc-form">
        <input class="vcc-file" id="vcc-file" type="file" data-testid="attachment-input">
